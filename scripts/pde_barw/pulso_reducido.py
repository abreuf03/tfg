...
from src.campo_medio.solvers import resolver_euler_explicito, resolver_imex_cn, resolver_imex_cn_reducido
...
def main() -> None:
    ...
    A, I = resolver_imex_cn_reducido(malla, config)
    ...
    np.savez(
        RESULTADOS / "reducido_solucion_pulso_campo_medio.npz",
        x=malla.x,
        t=malla.t,
        A=A,
        I=I,
    ...
    tabla_trayectoria.to_csv(
        RESULTADOS / "reducido_trayectoria_pulso.csv",
        index=False,
    )
    ...
    graficar_evolucion_perfiles(
        ...
        ruta=FIGURAS / "reducido_campo_medio_evolucion_pulso.png",
    )
    ...
    graficar_marco_movil(
        ...
        ruta=FIGURAS / "reducido_campo_medio_marco_movil.png",
    )
